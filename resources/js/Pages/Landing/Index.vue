...
<template>
    <div class="bg-surface-0 light:bg-surface-900">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div id="hero" class="flex flex-col pt-6 px-6 lg:px-20 overflow-hidden"
                style="background: linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), radial-gradient(77.36% 256.97% at 77.36% 57.52%, rgb(238, 239, 175) 0%, rgb(195, 227, 250) 100%); clip-path: ellipse(150% 87% at 93% 13%)">
                <div class="flex justify-end border-t lg:border-t-0 border-surface py-4 lg:py-0 mt-4 lg:mt-0 gap-2">
                    <Button label="Login" to="/auth/login" rounded></Button>
                </div>
                <div class="mx-6 md:mx-20 mt-0 md:mt-6">
                    <h1 class="text-6xl font-bold text-gray-900 leading-tight"><span class="font-light block">Dukung
                            Kandidat <br></span> Favorit di Event Spektakuler!</h1>
                    <p class="font-normal text-2xl leading-normal md:mt-4 text-gray-700">Berikan suaramu untuk kandidat
                        terbaik dan wujudkan kemenangan di event yang penuh semangat !</p>
                </div>
                ...
                <div class="grid grid-cols-12 gap-4 justify-center">
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                        <div
                            ...
                            <div class="p-4 bg-surface-0 light:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-surface-900 light:text-surface-0">Easy to Use</h5>
                                <span class="text-surface-600 light:text-surface-200">Posuere morbi leo urna
                                    molestie.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                        <div
                            ...
                            <div class="p-4 bg-surface-0 light:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-surface-900 light:text-surface-0">Fresh Design</h5>
                                <span class="text-surface-600 light:text-surface-200">Semper risus in hendrerit.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pb-8 mt-6 lg:mt-0">
                        <div
                            ...
                            <div class="p-4 bg-surface-0 light:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <div class="mt-6 mb-1 text-surface-900 light:text-surface-0 text-xl font-semibold">Well
                                    Documented</div>
                                <span class="text-surface-600 light:text-surface-200">Non arcu risus quis varius quam
                                    quisque.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                        <div
                            ...
                            <div class="p-4 bg-surface-0 light:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <div class="mt-6 mb-1 text-surface-900 light:text-surface-0 text-xl font-semibold">
                                    Responsive Layout</div>
                                <span class="text-surface-600 light:text-surface-200">Nulla malesuada pellentesque
                                    elit.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                        <div
                            ...
                            <div class="p-4 bg-surface-0 light:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <div class="mt-6 mb-1 text-surface-900 light:text-surface-0 text-xl font-semibold">Clean
                                    Code</div>
                                <span class="text-surface-600 light:text-surface-200">Condimentum lacinia quis vel
                                    eros.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pb-8 mt-6 lg:mt-0">
                        <div
                            ...
                            <div class="p-4 bg-surface-0 light:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <div class="mt-6 mb-1 text-surface-900 light:text-surface-0 text-xl font-semibold">light
                                    Mode</div>
                                <span class="text-surface-600 light:text-surface-200">Convallis tellus id interdum velit
                                    laoreet.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 mt-6 lg:mt-0">
                        <div
                            ...
                            <div class="p-4 bg-surface-0 light:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <div class="mt-6 mb-1 text-surface-900 light:text-surface-0 text-xl font-semibold">Ready
                                    to Use</div>
                                <span class="text-surface-600 light:text-surface-200">Mauris sit amet massa
                                    vitae.</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="p-4 bg-surface-0 light:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <div class="mt-6 mb-1 text-surface-900 light:text-surface-0 text-xl font-semibold">
                                    Modern
                                    Practices</div>
                                <span class="text-surface-600 light:text-surface-200">Elementum nibh tellus molestie
                                    nunc
                                    non.</span>
                            </div>
                        </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg-4 mt-6 lg:mt-0">
                        <div
                            ...
                            <div class="p-4 bg-surface-0 light:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <div class="mt-6 mb-1 text-surface-900 light:text-surface-0 text-xl font-semibold">
                                    Privacy</div>
                                <span class="text-surface-600 light:text-surface-200">Neque egestas congue
                                    quisque.</span>
                            </div>
                        </div>
                    </div>
            ...
            <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
                <div class="text-center">
                    <div class="text-surface-900 light:text-surface-0 font-normal mb-2 text-4xl">Powerful Everywhere
                    </div>
                ...
                <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
                    ...
                    <div
                        ...
                        <div class="leading-none text-surface-900 light:text-surface-0 text-3xl font-normal">Congue
                            Quisque Egestas</div>
                        <span class="text-surface-700 light:text-surface-100 text-2xl leading-normal ml-0 md:ml-2"
                ...
                <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
                    <div
                        ...
                        <div class="leading-none text-surface-900 light:text-surface-0 text-3xl font-normal">Celerisque
                            Eu Ultrices</div>
                        <span class="text-surface-700 light:text-surface-100 text-2xl leading-normal mr-0 md:mr-2"
                    ...
                    <div class="col-span-12 md:col-span-2">
                        <a @click="smoothScroll('#home')"
                            ...
                            <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-14 mr-2">
                                ...
                                <mask id="mask0_1413_1551" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0"
                                    y="8" width="54" height="11">
                                    <path
                            ...
                            <h4 class="font-medium text-3xl text-surface-900 light:text-surface-0">SAKAI</h4>
                        </a>
                    </div>
                        ...
                        <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                            <div class="col-span-12 md:col-span-3">
                                <h4
                                    ...
                                    Company</h4>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">About
                                    Us</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">News</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">Investor
                                    Relations</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">Careers</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer text-surface-700 light:text-surface-100">Media
                                    Kit</a>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                <h4
                                    ...
                                    Resources</h4>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">Get
                                    Started</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">Learn</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer text-surface-700 light:text-surface-100">Case
                                    Studies</a>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                <h4
                                    ...
                                    Community</h4>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">Discord</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">Events<img
                                        src="/demo/images/landing/new-badge.svg" class="ml-2" /></a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">FAQ</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer text-surface-700 light:text-surface-100">Blog</a>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                <h4
                                    ...
                                    Legal</h4>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">Brand
                                    Policy</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 light:text-surface-100">Privacy
                                    Policy</a>
                                <a
                                    class="leading-normal text-xl block cursor-pointer text-surface-700 light:text-surface-100">Terms
                                    of Service</a>
                            </div>
                        </div>
                    </div>
