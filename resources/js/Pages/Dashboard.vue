                ...
                <div class="card mb-0">
                    <div class="flex justify-between mb-4">
                        <div>
                            ...
                            <div class="text-surface-900 light:text-surface-0 font-medium text-xl">{{ props.users }}
                            </div>
                        </div>
                ...
                <div class="card mb-0">
                    <div class="flex justify-between mb-4">
                        <div>
                            ...
                            <div class="text-surface-900 light:text-surface-0 font-medium text-xl">{{ props.roles }}
                            </div>
                        </div>
                ...
                <div class="card mb-0">
                    <div class="flex justify-between mb-4">
                        <div>
                            ...
                            <div class="text-surface-900 light:text-surface-0 font-medium text-xl">{{ props.permissions
                                }}</div>
                        </div>
